...
- (id <EMSDWebImageOperation>)downloadImageWithURL:(NSURL *)url options:(EMSDWebImageDownloaderOptions)options progress:(EMSDWebImageDownloaderProgressBlock)progressBlock completed:(EMSDWebImageDownloaderCompletedBlock)completedBlock {
