...
//import UIKit
//
//class PublishArticleViewController: RootTableViewController {
//    
...
//            self.handleBack()
//        }
//        tableView.register(PublishArticleIndustryCell.self, forCellReuseIdentifier: "PublishArticleIndustryCell")
//    }
//    
...
//    
//    
//    lazy var inputCell: PublishArticleInputCell = {
//        let one = PublishArticleInputCell()
//        return one
//    }()
//    lazy var imagesCell: PublishArticleImagesCell = {
//        let one = PublishArticleImagesCell()
...
//                        let item = PublishArticleImageItem(isAddType: false)
//                        item.image = image
...
//                        var items = [PublishArticleImageItem]()
//                        for img in images {
//                            let item = PublishArticleImageItem(isAddType: false)
//                            item.image = img
//                            items.append(item)
...
//        return one
//    }()
//    lazy var industryHeadCell: PublishArticleIndustryHeadCell = {
//        let one = PublishArticleIndustryHeadCell()
//        return one
//    }()
//    
...
//        } else {
//            if industriesLoadStatus == .done {
//                let cell = tableView.dequeueReusableCell(withIdentifier: "PublishArticleIndustryCell") as! PublishArticleIndustryCell
...
//        if indexPath.section == 0 {
//            if indexPath.row == 0 {
//                return PublishArticleInputCell.cellHeight()
//            } else if indexPath.row == 1 {
//                return imagesCell.cellHeight
//            } else if indexPath.row == 2 {
//                return PublishArticleIndustryHeadCell.cellHeight()
//            }
//        } else {
//            if industriesLoadStatus == .done {
//                return PublishArticleIndustryCell.cellHeight()
//            } else {
//                return 200
//            }
//        }
...
//}
//
//class PublishArticleInputCell: RootTableViewCell, UITextViewDelegate {
...
//    }()
//    init() {
//        super.init(style: .default, reuseIdentifier: "PublishArticleInputCell")
...
//}
//
//class PublishArticleImagesCell: RootTableViewCell, UICollectionViewDataSource, UICollectionViewDelegate {
//    
//    var respondAdd: (() -> ())?
...
//    }
//    
//    var items: [PublishArticleImageItem] = [PublishArticleImageItem]()
//    lazy var addItem: PublishArticleImageItem = {
//        let one = PublishArticleImageItem(isAddType: true)
//        return one
//    }()
...
//        one.register(PublishArticleImagesInnerCell.self, forCellWithReuseIdentifier: "PublishArticleImagesInnerCell")
//        return one
//    }()
//    
...
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PublishArticleImagesInnerCell", for: indexPath) as! PublishArticleImagesInnerCell
//        if items.count < 9 {
...
//        var item: PublishArticleImageItem
//        if items.count < 9 {
//            if indexPath.item < items.count {
...
//}
//
//class PublishArticleImagesInnerCell: UICollectionViewCell {
//    var item: PublishArticleImageItem! {
//        didSet {
//            if item.isAddType {
...
//}
//
//class PublishArticleIndustryHeadCell: RootTableViewCell {
//    
//    var respondClick: (() -> ())?
//    
//    var fold: Bool? {
...
//}
//
//class PublishArticleIndustryCell: RootTableViewCell {
//    
//    override class func cellHeight() -> CGFloat {
//        return 40
//    }
